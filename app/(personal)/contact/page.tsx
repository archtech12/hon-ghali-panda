          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="mt-10">
                ...
                <div className="bg-gray-200 border-2 border-dashed border-red-300 rounded-xl w-full h-64 flex items-center justify-center">
                  <span className="text-gray-500">Map Placeholder (Gaya, Kano)</span>
                </div>
              </div>
